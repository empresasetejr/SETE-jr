...
/**
 * Base de conhecimento da Sete Jr para o chatbot manual e para a IA.
 * Ajuste estes dados quando vocês fecharem os textos oficiais do projeto.
 */
return [
    'nome' => 'Sete Jr',
    ...
    'publico' => [
        ...
        'Projetos comerciais que precisam organizar tecnologia, finanças ou comunicação',
    ],
    'faq' => [
        [
            'pergunta' => 'A Sete Jr faz site?',
